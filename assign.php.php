					...
					<tr>
						...
						<td width="60%">
							<font face="Verdana" size="4"
								color="white">
								Thanks for your interest on my portfolio								<hr color="black">
								Hi myself Aryan Sharma currently pursuing my Btech second year from Bennett University
								<hr color="black">
								...
								My Enrollment number is E20CSE087.
					...
					<tr>
						<td>
							<font face="Verdana" size="4" color="white">
								<ul>
									<li>
										<b>Data Science Club President at BU</b>
										<ul>
											<li>
												March,2020 - Present.
											</li>
											<li>
												Holds the functioning of club
											</li>
										</ul>
									</li>
				...
				<table border="0" cellpadding="15"
					...
					<tr>
						<td width="80%" valign="top">
							<font face="Verdana"
								color="#4CAF50" size="5">
								©Copyright 2050 by Aryan Sharma.
								All rights reserved.
							</font>
						</td>
